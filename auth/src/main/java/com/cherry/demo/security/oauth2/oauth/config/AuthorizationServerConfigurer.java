...
//    private DataSource dataSource;
    ...
    @Autowired
    public AuthorizationServerConfigurer(RedisConnectionFactory connectionFactory, @Qualifier("authenticationManager") AuthenticationManager authenticationManager, UserDetailsService userDetailsService) {
